"""
Django settings for AttendanceFP project.
...
# SECRET_KEY = 'django-insecure-f3w83x#c-jxz0+++)td0fk-wto*=7+5eq#srf^s92+^jovkjlo'
...
ROOT_URLCONF = 'AttendanceFP.urls'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'ssl': {
                'ca': '~/AttendanceFP/ca-certificate.crt'
            },
            "charset": "utf8mb4",
            'init_command': "SET sql_mode='STRICT_TRANS_TABLES'"
        }
